...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://esigas.com.ar/Image/logo-opengraph.png',
        width: 1200,
        height: 630,
        alt: 'Logo Esigas',
      },
  ...
  twitter: {
    ...
    description:
      'Empresa Servicios de Ingeniería. Modernizamos tu experiencia con GNC: información, ahorro y tecnología en un solo lugar para que disfrutes un servicio eficiente y sustentable.',
    images: ['https://esigas.com.ar/Image/logo-opengraph.png'],
  },
};
  ...
  return (
    <html lang="es">
      <head>
        {/* Google tag (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-NBXSH61VL1"
