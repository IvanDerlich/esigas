    ...
    return (
        <section className={`${lato.className} ${styles.section_sustainability}`}>
            <div className={styles.container_sustainability}>
                <h2 className={`${oswald.className} ${styles.title}`}>SOSTENIBILIDAD</h2>
                <div className={styles.container_text}>
                    <p className={styles.text}>
                        Nuestra visión es ayudar a combatir la contaminación ambiental y a
                        ralentizar el cambio climático. Creemos que es nuestra responsabilidad
                        proteger el medio ambiente para las generaciones futuras y estamos
                    ...
                    <p className={styles.text}>
                        ...
                        que otros combustibles fósiles, y queremos ayudar a nuestros clientes
                        a hacer la transición de manera eficiente y sostenible.
                    </p>
                    <p className={styles.text}>
                        En nuestra empresa, valoramos la integridad y el servicio por encima
                        de todo. Nos esforzamos por ser éticos en todas nuestras decisiones y
                        proporcionar un servicio excepcional a nuestros clientes. Nos
                    ...
                    <p className={styles.text}>
                        ...
                        hacer la transición a una fuente de energía más sostenible, no busque
                        más. Contáctenos hoy mismo para obtener más información y empezar a
                        alcanzar sus objetivos de sostenibilidad.»
                    </p>
                </div>
                <Link className={`${poppins.className} ${styles.link}`} href="https://api.whatsapp.com/send/?phone=5492615591335&text=">
                    <span>Contáctanos</span>
                </Link>
                <div className={styles.container_arguments}>
                    <div className={styles.container_check}>
                        <Image className={styles.logo} src={Check} width={22} height={18} alt="Check" priority />
                        <h3 className={`${poppins.className} ${styles.subtitle}`}>Un futuro más verde</h3>
                    </div>
                    <p className={styles.text}>
                ...
                <div className={styles.container_arguments}>
                    <div className={styles.container_check}>
                        <Image className={styles.logo} src={Check} width={22} height={18} alt="Check" priority />
                        <h3 className={`${poppins.className} ${styles.subtitle}`}>Un presente sin desigualdad</h3>
                    </div>
                    <p className={styles.text}>
